# Generated by Django 3.2.8 on 2022-01-25 21:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('worker', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='task.worker')),
            ],
            options={
                'ordering': ['-date_created'],
            },
